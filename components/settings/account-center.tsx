...
function buildHealthItems(settings: UserSettings, email: string) {
  ...
  return [
    ...
    { done: true, label: "Veri yedekleme alanı hazır" },
    {
      ...
      label: "Gizlilik tercihi seçildi",
    },
    {
...
export function AccountCenter({
  ...
  const healthPercent = Math.round((healthScore / healthItems.length) * 100);
  ...
  const dataCards = [
    ...
    ["Finans", accountData.counts.financeCount],
  ...
  return (
    <div className="space-y-5">
      ...
      <Card className="relative overflow-hidden rounded-[1.75rem] p-5 sm:p-6">
        <div className="pointer-events-none absolute -right-24 -top-28 size-80 rounded-full bg-[radial-gradient(circle,color-mix(in_srgb,var(--primary)_18%,transparent),transparent_70%)] blur-3xl" />
        <div className="relative flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="grid w-full gap-2 sm:grid-cols-3 lg:w-auto">
            <span className="app-surface-2 app-border inline-flex min-h-10 items-center justify-center gap-2 rounded-xl border px-3 text-xs font-semibold text-[var(--success)]">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h3 className="app-text mt-1 text-lg font-semibold">
                {healthScore} / {healthItems.length} adım hazır
              </h3>
            </div>
            <div className="app-surface-2 h-2 overflow-hidden rounded-full sm:w-44">
              <div
                className="h-full rounded-full bg-[linear-gradient(90deg,var(--primary),color-mix(in_srgb,var(--primary)_70%,var(--success)))]"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="app-muted mt-1 text-xs leading-5">
                  Finans tutarlarını ekranda maskeleyerek daha güvenli kullanım
                  sağlar.
                </p>
              </div>
            </div>
            <span className="app-surface-2 app-muted shrink-0 rounded-full border px-2.5 py-1 text-[10px] font-medium">
              {privacyEnabled ? "Aktif" : "Kapalı"}
            </span>
          </div>
          <SegmentedControl
      ...
      <Card className="p-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="app-text text-base font-semibold">Veri Özeti</h3>
            <p className="app-muted mt-1 text-xs leading-5">
              Çalışma alanındaki kayıtlarının genel durumunu görüntüle.
            </p>
          </div>
        </div>
        <div className="mt-4 grid gap-2 grid-cols-2 sm:grid-cols-3 xl:grid-cols-6">
      ...
      <Card className="p-4">
        ...
        >
          <span>
            <span className="app-text block text-base font-semibold">
              Gelişmiş Tercihler
            </span>
            <span className="app-muted mt-1 block text-xs leading-5">
              Güvenlik detayları, yedekleme, AI tercihleri, destek ve hesap
              işlemleri.
            </span>
          </span>
          <ChevronDown
            className={`app-muted size-5 shrink-0 transition ${
        ...
        {isAdvancedOpen ? (
          <div className="mt-4 grid gap-4 lg:grid-cols-2">
            <Card className="p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="app-muted mt-1 text-xs leading-5">
                    Oturum aktif. Şifre yenileme işlemini güvenli e-posta
                    bağlantısıyla başlatabilirsin.
                  </p>
                </div>
              </div>
            ...
            <Card className="p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="app-muted mt-1 text-xs leading-5">
                    Kayıtlarını kişisel arşivine alabilir ve yedekleme alanına
                    hızlıca geçebilirsin.
                  </p>
                </div>
              </div>
            ...
            <Card className="p-5">
              ...
              <p className="app-muted mt-1 text-xs leading-5">
                Yedekleme hatırlatma sıklığını belirle.
              </p>
              <SegmentedControl
            ...
            <Card className="p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="app-muted mt-1 text-xs leading-5">
                    Asistanın cevap tonunu ve günlük özet stilini seç.
                  </p>
                </div>
              </div>
            ...
            <Card className="p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="app-muted mt-1 text-xs leading-5">
                    Sorun yaşarsan güvenli bir sistem özeti veya geri bildirim
                    notu hazırlayabilirsin.
                  </p>
                </div>
              </div>
              <div className="mt-4 flex flex-col gap-2 sm:flex-row">
            ...
            <Card className="border-[color-mix(in_srgb,var(--danger)_24%,var(--border))] p-5 lg:col-span-2">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="app-muted mt-1 text-xs leading-5">
                    Hesap silme talebi gerçek silme işlemi başlatmaz. Önce
                    güvenli bir talep notu oluşturur ve yedek almanı önerir.
                  </p>
                </div>
              </div>
              <Button
